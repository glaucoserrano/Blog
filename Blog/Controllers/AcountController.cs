...
public class AcountController : ControllerBase
{
                ...
                [FromServices] EmailService emailService )
    {
        ...
        {
            return StatusCode(500, new ResultViewModel<string>("Esse Email já esta cadastrado"));
        }
        catch
        {
    ...
    [Authorize]
    [HttpPost("v1/acounts/upload-image")]
        ...
        [FromServices] BlogDataContext context)
    {
        ...
        user.Image = $"https://localhost:7259/images/{fileName}";
